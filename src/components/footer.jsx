...
const socialAccounts = [
  { icon: FaGithub, path: "https://github.com/deepak-gaikwad47", title: "Github" },
  { icon: FaLinkedin, path: "https://www.linkedin.com/in/deepak-gaikwad-3a4405183/", title: "Linkedin" },
  { icon: FaInstagram, path: "https://www.instagram.com/deepak_3522_?igsh=MTFzM2E0aHljdDFzNA==", title: "Instagram" },
];
